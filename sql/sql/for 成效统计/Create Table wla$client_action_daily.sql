CREATE TABLE `wla$client_action_daily` (
  `client_action_daily_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key, auto incremental',
  ...
  `entities` varchar NOT NULL COMMENT `实体ID的字符串， 厂家ID / 产品ID / 回复`
