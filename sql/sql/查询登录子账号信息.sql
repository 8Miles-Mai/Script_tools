...
select wu.comp_id 公司ID,
 ...
 where wu.status in (0, 7)
   ...
   and wu.last_login_time >= to_date(decode(:gtTime, '', wu.last_login_time, :gtTime), 'YYYY-mm-DD')
   and wu.last_login_time <= to_date(decode(:ltTime, '', wu.last_login_time, :ltTime), 'YYYY-mm-DD')