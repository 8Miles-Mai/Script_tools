...
#buying lead for buyer
        bzcat $log_files | grep "InquiryController.saveReply" | grep "compId" | ./014_mygmc_buying_reply_to_db.py
#buying lead for manufacturer
#        bzcat $log_files | grep "BuyingLSearchController.saveBLReply" | grep "compId" | ./014_mygmc_buying_reply_to_db.py
