...
# 2014-02-12 : miles.mai amended for change static data source -us -gz
# 2014-06-26 : miles.mai amended for change data source to tracker
#***********************************************************************
. gm_common.sh
...
#        zcat $db_file_gz".gz" $db_file_us".gz" | ./001_extract_display_log_to_db.py
./load_prod_keywords.py
#./001_extract_product_daily_exp_cnt.py
#        zcat $db_file".gz" | head -10000 | ./001_extract_display_log_to_db.py
