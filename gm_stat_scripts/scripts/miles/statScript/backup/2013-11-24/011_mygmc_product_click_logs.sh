...
#        bzcat $log_files | grep "InquiryController.viewDetailProfile" | grep "compId" | ./011_mygmc_product_click_to_db.py
        bzcat $log_files | grep "ProductController.viewDetailSum" | grep "productId" | ./011_mygmc_product_click_to_db.py
