...
export ORACLE_SID="(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST =192.168.86.17)(PORT = 1521)) (CONNECT_DATA =(SERVER = SHARED)(SID = core01)))"
export ORACLE_SERVICE="192.168.86.17:1521/core01.db.globalmarket.com"
export ORACLE_USER="APP_SOA2"
export ORACLE_PASSWORD="abc12355555"
...
export SOLR_SRV="192.168.86.110:8080"
...
export MDB_USER="app_soa"
export MDB_PASSWORD="app_soa"
